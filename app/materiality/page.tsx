    ...
    <div style={s.page}>
      ...
      <div style={s.wrap}>
        ...
        <section id="samples" style={{ ...s.section, scrollMarginTop: 80 }}>
          ...
          <p style={s.sectionLead}>
            Both samples below were generated by the live ThemisIQ Materiality Assessment for a fictional industrial-manufacturing entity (Acme Industries Ltd., FY2025) operating in the Mediterranean and Eastern North America. Same inputs, two standards — the difference is the standard, not the engine.
          </p>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 16, marginTop: 8 }}>
            {/* IFRS S2 sample */}
            <div style={{ background: '#fff', border: '2px solid #0C447C', borderRadius: 14, overflow: 'hidden' }}>
              <div style={{ background: '#E6F1FB', padding: '1.25rem 1.5rem', borderBottom: '1px solid rgba(12,68,124,0.2)' }}>
                ...
                <div style={{ fontFamily: 'Georgia, serif', fontSize: '1.25rem', color: '#0d0d0d' }}>Climate Risk &amp; Scenario Analysis Report</div>
                <div style={{ fontSize: 12, color: '#555553', marginTop: 4 }}>Single (financial) materiality · 5 pages</div>
              </div>
              <div style={{ padding: '1.25rem 1.5rem' }}>
                ...
                <a href="/themisiq-sample-ifrs-s2-report.pdf" target="_blank" rel="noopener noreferrer" style={{ ...primaryBtn, background: '#0C447C', color: '#fff' }}>
            ...
            <div style={{ background: '#fff', border: '2px solid #1e1b4b', borderRadius: 14, overflow: 'hidden' }}>
              <div style={{ background: '#eef2ff', padding: '1.25rem 1.5rem', borderBottom: '1px solid rgba(30,27,75,0.2)' }}>
                ...
                <div style={{ fontSize: 12, color: '#555553', marginTop: 4 }}>Double materiality · 6 pages · with matrix</div>
              </div>
              <div style={{ padding: '1.25rem 1.5rem' }}>
                <div style={{ fontSize: 13, color: '#374151', lineHeight: 1.7, marginBottom: 14 }}>
                ...
                <a href="/themisiq-sample-csrd-report.pdf" target="_blank" rel="noopener noreferrer" style={{ ...primaryBtn, background: '#1e1b4b', color: '#fff' }}>
