      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem' }}>
        <div style={{ width: '100%', maxWidth: 420 }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
            ...
            <p style={{ fontSize: 14, color: '#888784', fontWeight: 400 }}>Enter your email and we'll send you a reset link</p>
          </div>
          ...
          <div style={{ background: '#fff', border: '0.5px solid #e8e7e4', borderRadius: 16, padding: '2rem' }}>
            {sent ? (
              <div style={{ textAlign: 'center' }}>
                ...
                <p style={{ fontSize: 13, color: '#888784', fontWeight: 400, lineHeight: 1.5, margin: 0 }}>
