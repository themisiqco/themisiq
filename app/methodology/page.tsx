  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        // "automatically identifies" the likely material categories. The table behind it was keyed on a
        // retired sector vocabulary the sector select no longer offered, so it identified nothing for any
        // sector a customer could choose, and the feature was removed. Relevance is the customer's call.
        title: 'Relevance',
        content: 'Which Scope 3 categories are relevant is the customer\u2019s decision, made against the GHG Protocol\u2019s relevance criteria: size, influence, risk, stakeholder interest, outsourcing and sector guidance. ThemisIQ records each decision. A category marked not relevant is kept out of the total with the customer\u2019s reason where one is given, and every export counts the exclusions made without one.',
      },
    ],
  },
  {
