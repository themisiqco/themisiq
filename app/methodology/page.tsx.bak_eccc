...
const METHODOLOGIES = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: 'Stationary combustion and mobile combustion factors are sourced from the US EPA (2024) and DEFRA/DESNZ (2023). Electricity emission factors use eGRID 2023 for US locations and IEA grid factors for international locations. All factors are versioned and cited in exports.',
      },
      {
