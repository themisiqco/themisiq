              ...
              return (
                <div key={fw.id}>
                  <div style={{ background: '#0d0d0d', borderRadius: 12, padding: '2rem', marginBottom: '1rem' }}>
                    ...
                    <button onClick={() => dataConfirmed && generateExport(fw.id)} style={{ fontSize: 14, fontWeight: 500, opacity: dataConfirmed ? 1 : 0.4, cursor: dataConfirmed ? "pointer" : "not-allowed", padding: '12px 28px', borderRadius: 8, background: 'linear-gradient(135deg,#7425e3,#1fb1ff,#64fe3e)', color: '#0d0d0d', border: 'none', }}>
                    ...
                    <button onClick={() => dataConfirmed && generateAssurance()} style={{ fontSize: 14, fontWeight: 500, opacity: dataConfirmed ? 1 : 0.4, cursor: dataConfirmed ? 'pointer' : 'not-allowed', padding: '12px 28px', borderRadius: 8, background: '#0d0d0d', color: '#fff', border: 'none', marginLeft: 10 }}>Download Full Assurance Package (PDF)</button>
                  </div>
