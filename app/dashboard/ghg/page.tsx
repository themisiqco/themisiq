          ...
          return (
            <div key={fw.id}>
              ...
              <div style={{ background: '#f8f7f5', border: '0.5px solid #e8e7e4', borderRadius: 10, padding: '1rem', fontSize: 12, color: '#555553', lineHeight: 1.6 }}>
                <p style={{ fontSize: 11, color: "#555553", lineHeight: 1.6 }}>This report is provided for informational purposes only and requires third-party verification before formal submission.</p>
              </div>
            </div>
          )
        })}
