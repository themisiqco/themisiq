...
export default function MaterialityWizard() {
  ...
  async function submit() {
    ...
    try {
      ...
      setResult(data.result); setStep(resultsStep)
    } catch (e: any) {
  ...
  const renderResults = () => {
    ...
    return (
      <div>
        ...
        {/* honesty footnote */}
        <div style={{ background: '#E6F1FB', borderRadius: 10, padding: '12px 14px', fontSize: 12, color: '#0C447C', lineHeight: 1.6, marginBottom: 8 }}>
