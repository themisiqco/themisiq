      ...
      <div>
        ...
        <div style={{ background: '#0d0d0d', borderRadius: 12, padding: '1.5rem', textAlign: 'center' as const }}>
          ...
          <div style={{ display: 'flex', gap: 10, justifyContent: 'center', flexWrap: 'wrap' as const }}>
            ...
            <a href="/" style={{ fontSize: 13, padding: '10px 24px', borderRadius: 8, background: 'none', color: 'rgba(255,255,255,0.6)', border: '0.5px solid rgba(255,255,255,0.15)', textDecoration: 'none' }}>Start free trial</a>
          </div>
        </div>
    ...
    <div style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif', background: '#f8f7f5', minHeight: '100vh', color: '#0d0d0d' }}>
      ...
      <div style={{ padding: '2.5rem 1.5rem' }}>
        <div style={{ maxWidth: 680, margin: '0 auto' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
            <a href="/">
              <img src="/logo.png" alt="ThemisIQ" style={{ height: 120, width: "auto", mixBlendMode: "multiply" }} />
            </a>
          </div>
