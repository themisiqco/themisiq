...
function computeObligations(a: Answers): Obligation[] {
  ...
  if (driver === 'customer') regs.push({ name: 'GHG Inventory — Scope 1 & 2', jurisdiction: 'Global · customer requirement', urgency: 'high', urgency_label: 'HIGH PRIORITY', deadline: 'As requested by your customer', module: 'Climate · GHG', what: 'Most customer sustainability questionnaires require your Scope 1 and Scope 2 GHG emissions — the baseline metric every sustainability programme starts with.', action: 'Complete your GHG inventory using the ThemisIQ Climate module.' })
  if (driver === 'bank') regs.push({ name: 'Bank / Insurer ESG Questionnaire', jurisdiction: 'Global · your lender', urgency: 'high', urgency_label: 'HIGH PRIORITY', deadline: 'As requested by your bank or insurer', module: 'Climate · GHG + Risk', what: 'Banks and insurers are requiring ESG data for loan renewals and sustainability-linked financing. Climate risk and GHG emissions are the most commonly requested data points.', action: 'Complete your GHG inventory and climate risk assessment.' })
  if (driver === 'board') regs.push({ name: 'Board ESG Governance Programme', jurisdiction: 'Global · internal governance', urgency: 'medium', urgency_label: 'RECOMMENDED', deadline: 'As directed by your board', module: 'Climate · GHG', what: 'Boards are requesting ESG performance data for governance, talent attraction and reputational risk management — even without a regulatory mandate.', action: 'Start with a GHG inventory and supply chain risk assessment as the foundation of your ESG programme.' })
  if (driver === 'ahead') regs.push({ name: 'Proactive ESG Programme', jurisdiction: 'Global · best practice', urgency: 'medium', urgency_label: 'RECOMMENDED', deadline: 'At your own pace', module: 'Climate · GHG', what: 'Getting ahead of regulations now means less disruption when they become mandatory. SB 253, CSRD, EU AI Act and CS3D are all moving toward broader applicability.', action: 'Start with a GHG inventory and compliance gap assessment.' })
  if (driver === 'investor') regs.push({ name: 'Investor / PE ESG Requirements', jurisdiction: 'Global · your investors', urgency: 'high', urgency_label: 'HIGH PRIORITY', deadline: 'As required by your investor', module: 'Deals & Investment', what: 'Investors and PE firms are requiring portfolio companies to measure and report ESG performance as a condition of ongoing investment.', action: 'Establish a GHG inventory, supply chain risk register and governance framework.' }) 
