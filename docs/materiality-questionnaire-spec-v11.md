# Stakeholder Questionnaire & Impact Materiality — design spec v11
...
**Scale** — how serious the harm is for the people or the environment affected
...
> Point 3 names **who would notice** rather than a magnitude. A facilities
> manager can answer "would a regulator take an interest in this?" and cannot
> answer "is this serious?" — the second is the word being defined.
