...
| 11.15 | **System boundaries must align with the EU ETS — verification outstanding.** Regulation (EU) 2025/2083 (in force 20 Oct 2025) amended Art. 7(7)(a) of Reg. (EU) 2023/956 to require that system boundaries of production processes **shall be aligned with those covered by the EU ETS**. Recital (16) explains the effect: for some aluminium and steel goods whose embedded emissions are dominated by precursors, the finishing production steps are carried out by separate installations not covered by the EU ETS, and those steps are **excluded from the system boundary**. IR 2025/2547 was adopted 10 Dec 2025, *after* the amendment, so the boundary rules ThemisIQ built from may already implement this correctly — **but that has not been verified.** Note also Reg. 2025/2083 is absent from the spec's regulatory-basis citations and from the `/cbam` marketing citation table. | Correctness of SEE for downstream steel and aluminium goods — exactly the two live sectors. Not blocking today; nothing is known to be wrong. | Boundaries are as built from IR 2025/2547 §-by-§. **Do not "simplify" any boundary rule without first checking it against 2025/2083 Art. 7(7)(a) and IR 2025/2547.** Verification task: confirm 2547's system-boundary provisions implement the EU ETS alignment, and that the aggregated-goods-category boundaries in `lib/cbam/` match. If a gap is found it is a methodology defect, not a feature gap. |
