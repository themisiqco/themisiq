# Stakeholder Questionnaire & Impact Materiality — design spec v12
...
#### 5.3.1 The plain-language expansion — the ONLY source for contributor copy

⚠️ The table above is terse by necessity: it is table cells. A contributor is a
facilities manager or an HR director, not a sustainability specialist, and
"Major — serious harm" is not a phrase they can act on. This expansion is what
they read. It lives here, beneath the scale it describes, so the two cannot
drift — the same rule that keeps `question_framing` on the sub-topic row
rather than in application code.

⚠️ Transcribe this into `lib/materiality/severityScale.ts` VERBATIM. One copy,
imported by the contributor form and the report both. NOT into
`lib/materiality/severity.ts` — that file is pure calculation, and copy is not
calculation.

⚠️ **SCALE HAS TWO SETS, KEYED ON DIRECTION.** Scope does not, and
irremediability applies only to harm. Found on 18 August 2026 when the first
positive-impact form rendered "Severe. Grave harm. Life-changing or
life-threatening" under the heading *As a benefit* — one set of descriptions
written entirely for harm, shown to someone scoring a benefit. A contributor
reading that would reasonably score everything low.

**Scale — NEGATIVE impacts** — how serious the harm is for the people or the
environment affected

| | |
|---|---|
| **1 · Minor** | Noticeable, but limited. People would mention it; it does not change their health, their income or their safety. |
| **2 · Moderate** | Meaningful, and manageable. A real effect on health, income or the local environment, of a kind that can be put right through ordinary work. |
| **3 · Major** | Serious harm. Lasting damage to health, livelihoods or the environment — the kind a regulator or a journalist would take an interest in. |
| **4 · Severe** | Grave harm. Life-changing or life-threatening for the people affected, or irreversible damage to the environment. |

**Scale — POSITIVE impacts** — how much good it does for the people or the
environment affected

| | |
|---|---|
| **1 · Minor** | Noticeable, but limited. People would mention it; it does not change their health, their income or their safety. |
| **2 · Moderate** | Meaningful. A real improvement to health, income or the local environment, of a kind ordinary work sustains. |
| **3 · Major** | Substantial good. A lasting improvement to health, livelihoods or the environment — the kind a regulator or a journalist would take an interest in. |
| **4 · Transformative** | Life-changing for the people affected, or a lasting restoration of the environment. |

> Point 3 names **who would notice** rather than a magnitude, in both sets. A
> facilities manager can answer "would a regulator take an interest in this?"
> and cannot answer "is this serious?" — the second is the word being defined.
>
> ⚠️ **Point 1 is identical in both, deliberately.** "Noticeable but limited"
> is already direction-neutral, and rewording it for symmetry would make it
> worse.
>
> ⚠️ **Point 4's LABEL changes, not only its description.** "Severe benefit"
> is incoherent, so the positive set says **Transformative**. Anywhere the
> label is rendered from a shared constant rather than from the direction-keyed
> set, this is the point at which it breaks.
>
> ⚠️ **The two sets must stay parallel in MAGNITUDE.** A 3 means the same size
> of thing in both directions, because §6.2's severity arithmetic treats the
> numbers identically and does not know which set produced them. If one side
> drifts harder or softer than the other, the same score comes to mean two
> different things and nothing in the calculation could detect it.

**Scope** — how many people, or how much of the environment, is affected

> ⚠️ **One set, both directions.** These are counts, not judgements about harm
> — "many people, or several sites" reads correctly whether the impact is good
> or bad. Do not create a positive variant; there is nothing to vary.

| | |
|---|---|
| **1** | A few people, or one site. |
| **2** | Many people, or several sites. |
| **3** | Widespread — a whole region, or an entire workforce. |
| **4** | Systemic — the whole supply chain or ecosystem. |

**Irremediability** — how hard it is to put right *(negative impacts only,
ESRS 1 ¶41)*

| | |
|---|---|
| **1 · Readily reversible** | It can be put right quickly, using the resources of ordinary operations. |
| **2 · Reversible with effort** | It can be put right, but it takes deliberate work, money or time. |
| **3 · Reversible only at major cost, or over years** | Putting it right is possible, but slow or expensive enough that it may not happen. |
| **4 · Not realistically reversible** | It cannot be undone. Whatever is done afterwards, the people or the environment affected do not go back to how they were. |

> ⚠️ Point 4 deliberately avoids the word **compensation**. Compensation is a
> response to harm, not a reversal of it, and letting the two blur is how a 4
> gets scored as a 3.

**And the fourth answer, outside the scale on all three** — *Not enough
visibility to assess.* §6.1: a recorded answer, never a zero and never a low,
styled identically to the four points rather than as a way out of them.

---

#### 5.3.2 ⚠️ THE WORKSHEET NEEDS ITS OWN S1/S2 FRAMING — the survey's cannot be reused

`mr_esrs_subtopic_display.question_framing` carries the SURVEY's wording, and
it is second-person framing about a respondent's own workplace: *"in your own
workforce"* / *"in your organisation's workforce"* (20260828).

A worksheet contributor is a different speaker answering a different question.
The survey asks *what are conditions like where you work*. The worksheet asks
*what harm does this undertaking cause to these people*. Inheriting the survey
strings would put a quietly wrong question in front of an HR director, with
nothing erroring.

| Topic | Survey framing | **Worksheet framing** |
|---|---|---|
| S1 | in your own workforce | **on your own workforce** |
| S2 | in your organisation's workforce | **on workers in your value chain** |

The shift from **in** to **on** is the whole distinction: conditions inside a
workplace versus harm done to a group of people.

S2 names the value chain again because the worksheet contributor is the
customer's own colleague — an HR director — not a supplier contact. The
survey's "your organisation's workforce" exists because a supplier
representative answers there; that reason does not apply here.

⚠️ Store these as a SEPARATE column or table from `question_framing`. Two
strings for two instruments, never one string doing both jobs — the survey's
wording is correct for the survey and must not change.
