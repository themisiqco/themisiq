...
\restrict w1JmZIw0n2DLWW1pCohDGgA1vFEzhdczSJEamgCaZnBbUtD2dt7ugQiXRNNfMVN
...
CREATE POLICY cbam_verifier_access_owner ON public.cbam_verifier_access TO authenticated USING ((customer_user_id = auth.uid())) WITH CHECK (((customer_user_id = auth.uid()) AND (company_id IN ( SELECT companies.id
   FROM public.companies
  WHERE (companies.user_id = auth.uid())))));
...
CREATE POLICY ghg_inventories_owner ON public.ghg_inventories TO authenticated USING ((auth.uid() = user_id)) WITH CHECK (((auth.uid() = user_id) AND (company_id IN ( SELECT companies.id
   FROM public.companies
  WHERE (companies.user_id = auth.uid())))));
...
CREATE POLICY ghg_monthly_emissions_insert ON public.ghg_monthly_emissions FOR INSERT TO authenticated WITH CHECK (((auth.uid() = user_id) AND ((company_id IS NULL) OR (company_id IN ( SELECT companies.id
   FROM public.companies
  WHERE (companies.user_id = auth.uid()))))));
...
CREATE POLICY ghg_monthly_emissions_update ON public.ghg_monthly_emissions FOR UPDATE TO authenticated USING ((auth.uid() = user_id)) WITH CHECK (((auth.uid() = user_id) AND ((company_id IS NULL) OR (company_id IN ( SELECT companies.id
   FROM public.companies
  WHERE (companies.user_id = auth.uid()))))));
...
CREATE POLICY mci_owner_all ON public.materiality_custom_iros TO authenticated USING ((user_id = auth.uid())) WITH CHECK ((user_id = auth.uid()));
...
CREATE POLICY mfin_owner_all ON public.materiality_finalisations TO authenticated USING ((user_id = auth.uid())) WITH CHECK ((user_id = auth.uid()));
...
CREATE POLICY mfreq_owner_all ON public.materiality_finalisation_requirements TO authenticated USING ((user_id = auth.uid())) WITH CHECK ((user_id = auth.uid()));
...
CREATE POLICY mi1_owner_all ON public.materiality_iro1 TO authenticated USING ((user_id = auth.uid())) WITH CHECK ((user_id = auth.uid()));
...
CREATE POLICY sbti_company_profile_insert ON public.sbti_company_profile FOR INSERT TO authenticated WITH CHECK (((auth.uid() = user_id) AND (company_id IN ( SELECT companies.id
   FROM public.companies
  WHERE (companies.user_id = auth.uid())))));
...
CREATE POLICY sbti_company_profile_update ON public.sbti_company_profile FOR UPDATE TO authenticated USING ((auth.uid() = user_id)) WITH CHECK (((auth.uid() = user_id) AND (company_id IN ( SELECT companies.id
   FROM public.companies
  WHERE (companies.user_id = auth.uid())))));
...
CREATE POLICY sbti_cycle_insert ON public.sbti_cycle FOR INSERT TO authenticated WITH CHECK (((auth.uid() = user_id) AND (company_id IN ( SELECT companies.id
   FROM public.companies
  WHERE (companies.user_id = auth.uid())))));
...
CREATE POLICY sbti_cycle_update ON public.sbti_cycle FOR UPDATE TO authenticated USING ((auth.uid() = user_id)) WITH CHECK (((auth.uid() = user_id) AND (company_id IN ( SELECT companies.id
   FROM public.companies
  WHERE (companies.user_id = auth.uid())))));
...
CREATE POLICY sbti_scope3_coverage_insert ON public.sbti_scope3_coverage FOR INSERT TO authenticated WITH CHECK (((auth.uid() = user_id) AND (company_id IN ( SELECT companies.id
   FROM public.companies
  WHERE (companies.user_id = auth.uid())))));
...
CREATE POLICY sbti_scope3_coverage_update ON public.sbti_scope3_coverage FOR UPDATE TO authenticated USING ((auth.uid() = user_id)) WITH CHECK (((auth.uid() = user_id) AND (company_id IN ( SELECT companies.id
   FROM public.companies
  WHERE (companies.user_id = auth.uid())))));
...
CREATE POLICY sbti_targets_insert ON public.sbti_targets FOR INSERT TO authenticated WITH CHECK (((auth.uid() = user_id) AND (company_id IN ( SELECT companies.id
   FROM public.companies
  WHERE (companies.user_id = auth.uid())))));
...
CREATE POLICY sbti_targets_update ON public.sbti_targets FOR UPDATE TO authenticated USING ((auth.uid() = user_id)) WITH CHECK (((auth.uid() = user_id) AND (company_id IN ( SELECT companies.id
   FROM public.companies
  WHERE (companies.user_id = auth.uid())))));
...
\unrestrict w1JmZIw0n2DLWW1pCohDGgA1vFEzhdczSJEamgCaZnBbUtD2dt7ugQiXRNNfMVN
