...
//
// One dispatcher for every category whose figure is a sum of priced rows: Category 5's waste rows and
// Category 12's end-of-life materials. It reads catData[catId] and nothing else, which is the whole point:
...
export interface RowPricedData {
  wasteRows?: WasteRow[]
