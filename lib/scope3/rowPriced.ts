...
// Category 12's end-of-life materials, and (since 19 Sep 2026) Category 6's flight legs and rail journeys. It reads catData[catId] and nothing else, which is the whole point:
...
export interface RowPricedData extends BusinessTravelData {
  wasteRows?: WasteRow[]
